!function (t, e, n, o) {
    ...
    function a(t, e) {
        ...
        t && t.isDefaultPrevented() || (t.preventDefault(),
            ...
            (i = n.fancybox.getInstance()) && i.$trigger && i.$trigger.is(o) || (e.selector ? s = n(e.selector) : (a = o.attr("data-fancybox") || "") ? s = (s = t.data ? t.data.items : []).length ? s.filter('[data-fancybox="' + a + '"]') : n('[data-fancybox="' + a + '"]') : s = [o],
                (r = n(s).index(o)) < 0 && (r = 0),
                (i = n.fancybox.open(s, e, r)).$trigger = o))
    }
    if (t.console = t.console || {
        ...
        n.extend(g.prototype, {
            init: function () {
                var o, a, i = this, s = i.group[i.currIndex].opts;
            ...
            addContent: function (t) {
                ...
                n.each(i, function (t, e) {
                    ...
                    n.isPlainObject(e) ? (d = e,
                        u = e.opts || e) : "object" === n.type(e) && n(e).length ? (u = (i = n(e)).data() || {},
                            (u = n.extend(!0, {}, u, u.options)).$orig = i,
                        ...
                        "ajax" === d.type && ((l = c.split(/\s+/, 2)).length > 1 && (d.src = l.shift(),
                    ...
                    Object.keys(a.slides).length && (a.updateControls(),
                        (e = a.Thumbs) && e.isActive && (e.create(),
                            e.focus()))
            },
            addEvents: function () {
                var e = this;
                e.removeEvents(),
                    ...
                    r.on("keydown.fb", function (t) {
                        var o = (n.fancybox ? n.fancybox.getInstance() : null).current
                            , a = t.keyCode || t.which;
                        if (9 != a)
                            return !o.opts.keyboard || t.ctrlKey || t.altKey || t.shiftKey || n(t.target).is("input") || n(t.target).is("textarea") ? void 0 : 8 === a || 27 === a ? (t.preventDefault(),
            ...
            jumpTo: function (t, e) {
                var a, i, s, r, c, l, d, u, p, h = this, g = h.group.length;
                if (!(h.isDragging || h.isClosing || h.isAnimating && h.firstRun)) {
                    if (t = parseInt(t, 10),
                        !(s = h.current ? h.current.opts.loop : h.opts.loop) && (t < 0 || t >= g))
                        return !1;
                    ...
                    l = n.fancybox.getTranslate(c.$slide),
                        ...
                        i ? (p = l.left - (c.pos * l.width + c.pos * c.opts.gutter),
            ...
            createSlide: function (t) {
                var e, o, a = this;
                return o = (o = t % a.group.length) < 0 ? a.group.length + o : o,
            ...
            scaleToActual: function (t, e, a) {
                ...
                d.isAnimating || d.isMoved() || !f || "image" != u.type || !u.isLoaded || u.hasError || (d.isAnimating = !0,
                    ...
                    t = t === o ? .5 * p : t,
                    e = e === o ? .5 * h : e,
                    (i = n.fancybox.getTranslate(f)).top -= n.fancybox.getTranslate(u.$slide).top,
                    i.left -= n.fancybox.getTranslate(u.$slide).left,
                    c = g / i.width,
                    l = b / i.height,
                    s = .5 * p - .5 * g,
                    r = .5 * h - .5 * b,
                    g > p && ((s = i.left * c - (t * c - t)) > 0 && (s = 0),
                        s < p - g && (s = p - g)),
                    b > h && ((r = i.top * l - (e * l - e)) > 0 && (r = 0),
                        r < h - b && (r = h - b)),
                    d.updateCursor(g, b),
            ...
            getFitPos: function (t) {
                var e, o, a, i, s = t.$content, r = t.$slide, c = t.width || t.opts.width, l = t.height || t.opts.height, d = {};
                return !!(t.isLoaded && s && s.length) && (e = n.fancybox.getTranslate(this.$refs.stage).width,
                    ...
                    e -= parseFloat(r.css("paddingLeft")) + parseFloat(r.css("paddingRight")) + parseFloat(s.css("marginLeft")) + parseFloat(s.css("marginRight")),
                    o -= parseFloat(r.css("paddingTop")) + parseFloat(r.css("paddingBottom")) + parseFloat(s.css("marginTop")) + parseFloat(s.css("marginBottom")),
                    c && l || (c = e,
                        l = o),
                    (c *= a = Math.min(1, e / c, o / l)) > e - .5 && (c = e),
                    (l *= a) > o - .5 && (l = o),
                    "image" === t.type ? (d.top = Math.floor(.5 * (o - l)) + parseFloat(r.css("paddingTop")),
                        d.left = Math.floor(.5 * (e - c)) + parseFloat(r.css("paddingLeft"))) : "video" === t.contentType && (l > c / (i = t.opts.width && t.opts.height ? c / l : t.opts.ratio || 16 / 9) ? l = c / i : c > l * i && (c = l * i)),
                    d.width = c,
                    d.height = l,
                    d)
            },
            ...
            isScaledDown: function (t, e) {
                var a = !1
                    , i = this.current
                    , s = i.$content;
                return t !== o && e !== o ? a = t < i.width && e < i.height : s && (a = (a = n.fancybox.getTranslate(s)).width < i.width && a.height < i.height),
                    a
            },
            canPan: function (t, e) {
                var a = this.current
                    , i = null
                    , s = !1;
                return "image" === a.type && (a.isComplete || t && e) && !a.hasError && (s = this.getFitPos(a),
                    t !== o && e !== o ? i = {
                        width: t,
                        height: e
                    } : a.isComplete && (i = n.fancybox.getTranslate(a.$content)),
            ...
            setBigImage: function (t) {
                ...
                t.$image = i.one("error", function () {
                    ...
                    t.$ghost || (o.resolveImageSlideSize(t, this.naturalWidth, this.naturalHeight),
                        o.afterLoad(t)),
                        o.isClosing || (t.opts.srcset && ((e = t.opts.sizes) && "auto" !== e || (e = (t.width / t.height > 1 && s.width() / s.height() > 1 ? "100" : Math.round(t.width / t.height * 100)) + "vw"),
                ...
                n.fancybox.isMobile && (i.css.overflow = "scroll"),
                    ...
                    i.preload ? (a.showLoading(t),
                        ...
                        s.on("refresh.fb", function () {
                            var n, a = t.$content, r = i.css.width, c = i.css.height;
                            if (1 === e[0].isReady) {
                                try {
                                ...
                                n && n.length && n.children().length && (s.css("overflow", "visible"),
                                    ...
                                    c === o && (c = Math.ceil(Math.max(n[0].clientHeight, n.outerHeight(!0)))),
                                    a.css("height", c || ""),
                                    s.css("overflow", "auto")),
            ...
            adjustCaption: function (t) {
                var e = this
                    ...
                    , a = e.$refs.caption
                    , i = !1;
                n.opts.preventCaptionOverlap && o && o.length && (n.pos !== e.currPos ? ((a = a.clone().empty().appendTo(a.parent())).html(o),
                    i = a.outerHeight(!0),
            ...
            adjustLayout: function (t) {
                ...
                i.isLoaded && !0 !== i.opts.disableLayoutFix && (i.$content.css("margin-bottom", ""),
                    i.$content.outerHeight() > i.$slide.height() + .5 && (o = i.$slide[0].style["padding-bottom"],
                        a = i.$slide.css("padding-bottom"),
                        parseFloat(a) > 0 && (e = i.$slide[0].scrollHeight,
                            i.$slide.css("padding-bottom", 0),
                            Math.abs(e - i.$slide[0].scrollHeight) < 1 && (n = a),
                            i.$slide.css("padding-bottom", o))),
                    i.$content.css("margin-bottom", n))
            },
            revealContent: function (t) {
                var e, a, i, s, r = this, c = t.$slide, l = !1, d = !1, u = r.isMoved(t), p = t.isRevealed;
            ...
            getThumbPos: function (t) {
                ...
                return !(!c || !h(c[0])) && (e = n.fancybox.getTranslate(c),
            ...
            focus: function (t, o) {
                ...
                s.isClosing || ((a = (a = !t && s.current && s.current.isComplete ? s.current.$slide.find("*:visible" + (o ? ":not(.fancybox-close-small)" : "")) : s.$refs.container.find("*:visible")).filter(r).filter(function () {
                    return "hidden" !== n(this).css("visibility") && !n(this).hasClass("disabled")
                })).length ? (i = a.index(e.activeElement),
            ...
            close: function (t, e) {
                var o, a, i, s, r, c, d, u = this, p = u.current, h = function () {
                    u.cleanUp(t)
                };
                return !(u.isClosing || (u.isClosing = !0,
                    !1 === u.trigger("beforeClose", t) ? (u.isClosing = !1,
                        ...
                        1) : (u.removeEvents(),
                            ...
                            u.hideControls(!0),
                            u.updateCursor(),
                            "zoom" !== o || i && a && "image" === p.type && !u.isMoved() && !p.hasError && (d = u.getThumbPos(p)) || (o = "fade"),
                            "zoom" === o ? (n.fancybox.stop(i),
                                ...
                                "auto" == r && (r = Math.abs(p.width / p.height - d.width / d.height) > .1),
                                r && (d.opacity = 0),
                                n.fancybox.setTranslate(i, c),
                                f(i),
                                n.fancybox.animate(i, d, a, h),
                                0) : (o && a ? n.fancybox.animate(p.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + o, a, h) : !0 === t ? setTimeout(h, a) : h(),
                                    0))))
            },
            cleanUp: function (e) {
            ...
            trigger: function (t, e) {
                ...
                return s ? a.unshift(s) : s = i,
                    ...
                    !1 === o ? o : void ("afterClose" !== t && i.$refs ? i.$refs.container.trigger(t + ".fb", a) : r.trigger(t + ".fb", a))
            },
        ...
        d.prototype.destroy = function () {
            ...
            d.prototype.onSwipe = function (e) {
                ...
                if (!0 !== c)
                    ...
                    if (s.canTap = !1,
                        r.group.length < 2 && s.opts.vertical ? s.isSwiping = "y" : r.isDragging || !1 === s.opts.vertical || "auto" === s.opts.vertical && n(t).width() > 800 ? s.isSwiping = "x" : (i = Math.abs(180 * Math.atan2(s.distanceY, s.distanceX) / Math.PI),
            ...
            d.prototype.limitPosition = function (t, e, n, o) {
                var a = this.canvasWidth
                    , i = this.canvasHeight;
                return n > a ? t = (t = t > 0 ? 0 : t) < a - n ? a - n : t : t = Math.max(0, a / 2 - n / 2),
                    o > i ? e = (e = e > 0 ? 0 : e) < i - o ? i - o : e : e = Math.max(0, i / 2 - o / 2),
                {
                    top: e,
                    left: t
                }
            ...
            d.prototype.endSwiping = function (t, e) {
                ...
                o.sliderLastPos = null,
                    "y" == t && !e && Math.abs(o.distanceY) > 50 ? (n.fancybox.animate(o.instance.current.$slide, {
                        ...
                        a = o.instance.close(!0, 250)) : r && o.distanceX > 0 ? a = o.instance.previous(300) : r && o.distanceX < 0 && (a = o.instance.next(300)),
                    !1 !== a || "x" != t && "y" != t || o.instance.centerSlide(200),
                    o.$container.removeClass("fancybox-is-sliding")
            }
            ,
            d.prototype.endPanning = function () {
                var t, e, o, a = this;
                a.contentLastPos && (!1 === a.opts.momentum || a.dMs > 350 ? (t = a.contentLastPos.left,
                    e = a.contentLastPos.top) : (t = a.contentLastPos.left + 500 * a.velocityX,
                        e = a.contentLastPos.top + 500 * a.velocityY),
                    (o = a.limitPosition(t, e, a.contentStartPos.width, a.contentStartPos.height)).width = a.contentStartPos.width,
        ...
        e.extend(n.prototype, {
            ...
            set: function (t) {
                var n = this
                    , o = n.instance
                    , a = o.current;
                a && (!0 === t || a.opts.loop || o.currIndex < o.group.length - 1) ? n.isActive && "video" !== a.contentType && (n.$progress && e.fancybox.animate(n.$progress.show(), {
                    scaleX: 1
    ...
    function (t, e) {
        ...
        e.extend(a.prototype, {
            ...
            focus: function (t) {
                ...
                a.instance.current && (n = (e = i.children().removeClass(o).filter('[data-index="' + a.instance.current.index + '"]').addClass(o)).position(),
    ...
    function (t, e) {
        ...
        e.extend(!0, e.fancybox.defaults, {
            ...
            e(t).on("click", "[data-fancybox-share]", function () {
                var t, n, o = e.fancybox.getInstance(), a = o.current || null;
                a && ("function" === e.type(a.opts.share.url) && (t = a.opts.share.url.apply(a, [o, a])),
                    n = a.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === a.type ? encodeURIComponent(a.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(t)).replace(/\{\{url_raw\}\}/g, function (t) {
                        var e = {
                            "&": "&amp;",
                            "<": "&lt;",
                            ">": "&gt;",
                ...
                !1 !== n.fancybox.defaults.hash && (n(e).on({
                    "onInit.fb": function (t, e) {
                        ...
                        !1 !== e.group[e.currIndex].opts.hash && (n = o(),
                            (a = i(e)) && n.gallery && a == n.gallery && (e.currIndex = n.index - 1))
                    },
                    "beforeShow.fb": function (n, o, a, s) {
                        var r;
                        a && !1 !== a.opts.hash && ((r = i(o)) && (o.currentHash = r + (o.group.length > 1 ? "-" + (a.index + 1) : ""),
                    ...
                    "beforeClose.fb": function (n, o, a) {
                        !1 !== a.opts.hash && (clearTimeout(o.hashTimer),
